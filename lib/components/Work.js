  ...
  return (
    <div className='work' id='work'>
      <div className='border'>
        ...
        <a onClick={() => {this.props.grabProject({image: 'RemEMBER.png', title: 'RemEMBER', description: 'An application created in Ember to keep track of todos.', link: 'https://github.com/jksmall0631/1610-remember-1'})}}>
          <Split title='RemEMBER' container='title-container' first='first' second='second' />
        </a>
        <a onClick={() => {this.props.grabProject({image: 'frogger.png', title: 'FROGGER', description: 'An application created in Javascript using canvas. You know the game, get the frog across the street.', link: 'https://github.com/jksmall0631/frogger'})}}>
