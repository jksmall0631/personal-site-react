      ...
      <header className='header'>
        ...
        <nav className='nav'>
          <ul>
            {/* <li>
              <a href="#">
                <Split title='ABOUT' container='title-container-nav' first='first-nav' second='second-nav' />
              </a>
            </li> */}
            <li>
              <a href='#work'>
            ...
            {/* <li>
              <Link to={'/background'}>
                <Split title='BACKGROUND' container='title-container-nav' first='first-nav' second='second-nav' />
              </Link>
            </li> */}
            <li>
